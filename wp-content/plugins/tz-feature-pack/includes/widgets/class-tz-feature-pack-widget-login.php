...
<!--			</div>-->
		...
		<?php if (!$inline) { echo '<div class="tz-login-form-wrapper">'; } ?>
			...
			<form id="tz-login" class="ajax-auth" method="post">
				<div class="like-h3 heading"><?php esc_html_e('Login', 'tz-feature-pack');?></div>
				<p class="status"></p>
				...
				<div class="like-h3 botom-links"><?php esc_html_e('New to site? ', 'tz-feature-pack');?><a id="tz-pop-register" href="#"><?php esc_html_e('Create an Account', 'tz-feature-pack');?></a></div>
				<?php if ( function_exists('oa_social_login_render_login_form') ) {
					$settings = get_option ('oa_social_login_settings');
					if (is_array ($settings ['providers'])) {
						echo '<div class="like-h3">' . esc_html__('Or login to site using social networks', 'tz-feature-pack') . '</div>';
			...
			<form id="tz-register" class="ajax-auth" method="post">
				<div class="like-h3 heading"><?php esc_html_e('Register', 'tz-feature-pack');?></div>
				<p class="status"></p>
				...
				<div class="like-h3 botom-links"><?php esc_html_e('Already have an account? ', 'tz-feature-pack');?><a id="tz-pop-login" href="#"><?php esc_html_e('Login', 'tz-feature-pack');?></a></div>
				<a class="tz-form-close" href="#"><?php esc_html_e('(close)', 'tz-feature-pack');?></a>
		</form>
