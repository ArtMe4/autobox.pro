...
if (class_exists('Chromium_Kirki')) {
	...
	Chromium_Kirki::add_field( 'chromium', array(
		...
		'output'   => array(
			array(
				'element'  => '.site-header .site-title',
...
if (class_exists('WooCommerce')) {
		...
		'output'      => array(
				...
				array(
					...
					'element'  => array( 'a:hover','a:focus','a:active','.tz-categories-grid li:not(.show-all) a:hover','.tz-categories-grid li:not(.show-all) a:focus',
                                                            ...
                                                            '.related-posts .like-h3 a:hover','.related-posts .like-h3 a:focus','.related-posts .like-h3 a:active',
		...
		'output'      => array(
				...
				array(
					...
					'element'  => array(
						...
						'.site-content h5',
                        '.site-content h6',
                        '.site-content .like-h1',
                        '.site-content .like-h2',
                        '.site-content .like-h3',
                        '.site-content .like-h4',
                        '.site-content .like-h5',
                        '.site-content .like-h6',
                        '.single-label span',
                        'blockquote',
						'.product-shares-wrapper .tz-social-links .heading',
                        'div.product .price',
						'.site-sidebar .comment-author-link a',
                        '.product .price',
				...
				array(
					...
					'element'  => array(
                        ...
                        '.site-sidebar h5',
                        '.site-sidebar h6',
                        '.site-sidebar .like-h1',
                        '.site-sidebar .like-h2',
                        '.site-sidebar .like-h3',
                        '.site-sidebar .like-h4',
                        '.site-sidebar .like-h5',
                        '.site-sidebar .like-h6',
						'.site-sidebar h1 a',
						'.site-sidebar h2 a',
						'.site-sidebar h3 a',
						'.site-sidebar h4 a',
						'.site-sidebar h5 a',
						'.site-sidebar h6 a',
                        '.site-sidebar .like-h1 a',
                        '.site-sidebar .like-h2 a',
                        '.site-sidebar .like-h3 a',
                        '.site-sidebar .like-h4 a',
                        '.site-sidebar .like-h5 a',
                        '.site-sidebar .like-h6 a'
						),
					'property' => 'color',
				),
				array(
	...
	Chromium_Kirki::add_field( 'chromium', array(
		...
		'output'      => array(
				array(
					'choice'   => 'border',
					'element'  => array('.primary-nav','.widget .widget-title','.elementor-widget h5','.elementor-widget .like-h5',
															...
															'table th','.cross-sells h2','.cart_totals h2','.cross-sells .like-h2','.cart_totals .like-h2','.tz-hoverable-tabs ul.nav li',
															'.woocommerce-checkout-review-order-table .img','article.type-post .post-cats','article.type-post .post-tags',
															'.author-info h3','.author-info .like-h3','.post-navigation .nav-links','.comment .child-comments',
															'#reviews ol.commentlist','.woocommerce-MyAccount-navigation','.woocommerce-MyAccount-navigation ul li',
															'.woocommerce-checkout h2','.woocommerce-checkout .like-h2','table.order_details','table.order_details th','table.order_details td',
